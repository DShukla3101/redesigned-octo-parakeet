...
from team_scoreboard import Ui_Dialog as Score  #Score window
import sqlite3
...
class Ui_evaluate_team(object):
    ...
    def setupUi(self, evaluate_team):
        ...
        evaluate_team.setStyleSheet("background-color: rgb(170, 170, 255);")
...
"font: 75 italic 11pt \"Century Gothic\";")
        ...
        self.calcscore_btn.setStyleSheet("font: 75 10pt \"Arial\";")
